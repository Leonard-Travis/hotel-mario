...
<table width="100%">
	<?php $cant_adults = (int) $cant_adults;
        ...
        <tr> <td width="50%">
        <input type="text" name="<?php echo($cont_f); ?>_adult<?php echo($i); ?>_name" id="<?php echo($cont_f); ?>_adult<?php echo($i); ?>_name" value="nombre" onclick="document.travelers_info.<?php echo($cont_f); ?>_adult<?php echo($i); ?>_name.value ='';" size="50" />
        </td>
        ...
        <tr> <td>CI &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text" name="<?php echo($cont_f); ?>_adult<?php echo($i); ?>_ci" id="<?php echo($cont_f); ?>_adult<?php echo($i); ?>_ci"/></td>
        </tr>
    ...
    <?php } ?>
    <tr> <td></td> <td align="center"> <img src="http://localhost/hotel-mario/designed_views/imagenes/bprocesar.jpg" onclick="travelers(<?php echo($cont_f); ?>);" />
    </td> </tr>
</table>
</form>
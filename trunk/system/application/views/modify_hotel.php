...
<?php echo form_open('modify_hotel'); ?>
	...
	<table align="center" width="40%">
		<?php foreach ($query as $hotel_selected) { ?>
            ...
            <tr>
            <td>Habitaciones (escoge la que desees desasociar del hotel)</td>
            <td>
            ...
            <tr>
            <td>Planes (escoge el desees desasociar del hotel)</td>
            <td>
		...
		<?php }?>
		<tr> <td><input type="submit" value="Aceptar"  /></td>
</form>
		    <?php echo form_open('associate_room'); ?>
            <input type="hidden" name="hotel_id_aux" id="hotel_id_aux" value="<?php echo ($hotel_id_aux);?>"  />
            <td><input type="submit" value="Asociar nuevo tipo de Habitacion al Hotel" /></td> </tr>
            </form>
	</table>

...
<div id="asociar_c">
	...
	<?php echo validation_errors(); ?>
<form name="form1" method="post" action="<?php echo base_url(); ?>customer/new_client" onSubmit="return valida(this);">
    ...
    <ul class="ul_tit_2">    
        ...
        <li><div class="cajat"><input type="text" name="ci_client" readonly="readonly" value="<?php echo($ci_customer); ?>"/></div></li>
        <li class="li_tit_2">Nombre:</li> 
        <li><div class="cajat"><input type="text" name="nombre" maxlength="15"/></div></li>
        <li class="li_tit_2">Apellido:</li>
        <li><div class="cajat"><input type="text" name="apellido" maxlength="15"/></div></li>
        <li class="li_tit_2">Telefono:</li>
        <li><div class="cajat"><input type="text" name="tlf" maxlength="20"/> </div></li>
        <li class="li_tit_2">e-mail:</li>
        <li><div class="cajat"><input type="text" name="email" maxlength="40"/> </div></li>
        <li class="li_tit_2">Direccion:</li>
        <li><textarea name="direccion" cols="18" rows=""  maxlength="50"></textarea></li>
        <li class="li_tit_2">Fecha de Nacimiento:</li>
        <li><div class="cajat"><input type="text" name="fecha" onclick="popUpCalendar(this, form1.fecha, 'yyyy-mm-dd')" readonly="readonly" /></div></li>
        ...
        <li class="li_tit_2"><input name="enviar" type="submit" value="Agregar" /></li><li></li> 
    </ul>
    </div>
    </div>
</form>

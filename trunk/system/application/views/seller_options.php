...
?>
    <ul class="ul_tit_2">    
        ...
        <li><div class="cajat">
            <input type="text" id="emp_ci" id="emp_ci" readonly="readonly" value="<?php echo($emp[0]['employees_id']); ?>"/>
        </div></li>
        ...
        <li><div class="cajat">
            <input type="text" id="lastname" <?php echo $readonly;?> value="<?php echo($emp[0]['lastname']); ?>" />
        </div>
        	<?php if($modify == 'yes'){ ?>
            	<img src="<?php echo IMG;?>exclamation.png" />
            <?php } ?>
        ...
        <li><div class="cajat">
            <input type="text" id="nick_name" <?php echo $readonly;?> value="<?php echo ($emp[0]['nick_name']); ?>" /> 
        </div>
        	<?php if($modify == 'yes'){ ?>
            	<img src="<?php echo IMG;?>exclamation.png" />
            <?php } ?>
        ...
        <li>
            <a href="javascript:void(0);">Cambiar Clave</a>
        </li>
